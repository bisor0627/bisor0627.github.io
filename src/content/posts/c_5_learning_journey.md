...
초기에는 단순한 **툴 세팅 가이드**를 [문서화](how-to-setting.md)했다. Swift 학습에 게을러 아직도 Flutter가 익숙한 나는 Flutter 환경에서 GA4, Amplitude를 세팅하는 방법 안내서를 작성했고, 멘토(Gommin)에게 다음과 같은 피드백을 받았다.
...
→ [개발자라면 놓치지 말아야 할 이벤트 설계의 포인트들](event-taxonomy-guide.md)
